...
|--------|-------|--------|--------|-------------|
| Relicense to Apache-2.0 | claude | in review | `claude/relicense-apache-2.0` | Relicense OTOI from MIT to Apache-2.0 across root, nested `nlt-otoi/`, and the new `packages/otoi/LICENSE`; bump `@neurolift-technologies/otoi` to 1.1.0. npm publish deferred to post-merge |
