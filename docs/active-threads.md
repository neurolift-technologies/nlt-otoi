...
| PR #31 npm scope documentation follow-up | GPT-5.5 / Cursor Automation | pending | #32 | Updated runbooks after `@neurolift` to `@neurolift-technologies` rename and validator schema restoration |
