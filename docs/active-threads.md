...
|--------|-------|--------|--------|-------------|
| License documentation alignment | cursor | active | `cursor/engineering-documentation-updates-4a6b` | Document the PR #36 LICENSE update and related package/contributor license maintenance paths |
